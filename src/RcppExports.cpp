...
List GENERALIZED_LOGISTIC(double r_max, double K, double N1, double z, double q, double start_yr, double num_Yrs, NumericVector catches, double MVP);
RcppExport SEXP _HumpbackSIR_GENERALIZED_LOGISTIC(SEXP r_maxSEXP, SEXP KSEXP, SEXP N1SEXP, SEXP zSEXP, SEXP qSEXP, SEXP start_yrSEXP, SEXP num_YrsSEXP, SEXP catchesSEXP, SEXP MVPSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(GENERALIZED_LOGISTIC(r_max, K, N1, z, q, start_yr, num_Yrs, catches, MVP));
...
static const R_CallMethodDef CallEntries[] = {
    {"_HumpbackSIR_GENERALIZED_LOGISTIC", (DL_FUNC) &_HumpbackSIR_GENERALIZED_LOGISTIC, 9},
